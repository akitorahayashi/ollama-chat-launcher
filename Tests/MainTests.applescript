...
-- 2. Run this script from the root of the repository using: osascript Tests/MainTests.applescript
...
try
    run script POSIX file (POSIX path of (path to me) & "/../Tinyllama.applescript")
